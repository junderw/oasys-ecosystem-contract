 ...
 */
contract OriginalTokenVaultV2 is
    ReentrancyGuard,
    Pauser,
    VolumeControl,
    DelayedTransfer
{
    ...
    ISigsVerifier public constant sigsVerifier =
        ISigsVerifier(0x5200000000000000000000000000000000000015);
    ...
    function _deposit(
        ...
        require(
            maxDeposit[_token] == 0 || _amount <= maxDeposit[_token],
            "amount too large"
        );
    ...
    function withdraw(
        ...
        bytes32 domain = keccak256(
            abi.encodePacked(block.chainid, address(this), "Withdraw")
        );
